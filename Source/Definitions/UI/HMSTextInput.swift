...
//  HadiMovieSearch
//
//  Created by Can Özcan on 16.01.2020.
//  Copyright © 2020 CanOzcan. All rights reserved.
//

import UIKit

open class HMSTextInput: UITextField, UITextFieldDelegate {
...
//    open var whileEdit: Action!
    ...
    public func whileEdit(delegate: @escaping ActionWith<UITextField>){
        ...
        self.addTarget(self, action: #selector(HMSTextInput.textFieldDidChange(_:)), for: UIControl.Event.editingChanged)
    }
    ...
    public func activateMovement(layout: HMSLayout) {
        self.layout = layout
